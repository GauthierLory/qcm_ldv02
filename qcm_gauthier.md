...
[x] 55  le foreach est-il en double ???
...
[x] Association permanente car des l'instanciation de la classe RaspberryPi l'objet de type type Log est necessaire.
...
[x] Association ponctuelle car la methode de la classe RaspberryPI est dependante d'une autre classe de maniere ponctuelle
...
[x] Agrégation car L’objet RaspberryPi connait l’objet Sd et contient des Sd, de plus la classe RaspberryPi dépend de Sd.
...
[x] Composition car l'objet RaspberryPi connait l'objet Arm et gere le cycle de vie de Arm
...
[x] Non car le constructeur est prive a l'instanciation
...
[x] Non c'est une classe abstraite donc non concrete et donc ne peut pas etre instancie
